...
```bash
git clone https://github.com/mengheangkh/m.h4ck-camera.git
```
...
```bash
chmod +x mh4ck-camera.sh
```

### 4. Run

```bash
 bash mh4ck-camera.sh
      or
./mh4ck-camera.sh
```
...
| Location | `captured_location.txt` |
